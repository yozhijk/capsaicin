...
void GUISystem::RenderGUI(SettingsComponent& settings)
{
    ...
    ImGui::Text("Gather parameters");
    ImGui::SliderFloat("Normal sigma", &settings.gather_normal_sigma, 32.f, 256.f);
    ImGui::SliderFloat("Depth sigma", &settings.gather_depth_sigma, 0.1f, 10.f);
    ImGui::SliderFloat("Luminance sigma", &settings.gather_luma_sigma, 0.1f, 10.f);
    ImGui::Separator();
